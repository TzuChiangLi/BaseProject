...
public class CircleProgressView extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.CircleProgressView_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.CircleProgressView_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.CircleProgressView_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.CircleProgressView_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.CircleProgressView_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.CircleProgressView_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.CircleProgressView_barColor, barColor);

        rimColor = a.getColor(R.styleable.CircleProgressView_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.CircleProgressView_linearProgress, false);

        if (a.getBoolean(R.styleable.CircleProgressView_progressIndeterminate, false)) {
            spin();
        }

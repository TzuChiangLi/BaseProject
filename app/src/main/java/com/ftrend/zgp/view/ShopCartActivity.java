...
public class ShopCartActivity extends BaseActivity implements ShopCartContract.ShopCartView, OnTitleBarListener {
    ...
    private ShopAdapter<Product> mProdAdapter;
    ...
    @Override
    public void setProdList(final List<Product> prodList) {
        ...
        mProdAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final BaseQuickAdapter adapter, View view, final int position) {
                ...
                final Product prod = (Product) adapter.getItem(position);
    ...
    @Override
    public void setScanProdPosition(final int index) {
        mProdRecyclerView.smoothScrollToPosition(index);
        final Product prod = mProdAdapter.getData().get(index);

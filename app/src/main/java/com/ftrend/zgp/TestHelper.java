...
public class TestHelper {
    ...
    private static void depProd2Code() {
        ...
        final String TPL = "prodList.add(new DepProduct(\"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", %.2f)\n"
        ...
        for (DepProduct product : productList) {
            output(TPL,
                    product.getDepCode(), product.getProdCode(), product.getBarCode(),
    ...
    private static void appParams2Code() {
        ...
        // TODO: 2019/9/29 这里的查询条件不起作用，可能和转义字符有关

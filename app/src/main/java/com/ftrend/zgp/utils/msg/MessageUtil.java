...
//-------------------------------------模态弹窗-----------------------------------------//
     ...
     * 退货选择
     */
    public static void rtnProd(ProdDialog.onDialogCallBack callBack) {
        Context context = ActivityUtils.getTopActivity();
        new XPopup.Builder(context)
                .dismissOnTouchOutside(false)
                .hasShadowBg(true)
                .moveUpToKeyboard(false)
                .asCustom(new ProdDialog(context, callBack))
                .show();
    }
    /**
     * 设置刷卡商品
     */
    public static void vipProd(ProdDialog.onDialogCallBack callBack) {
        Context context = ActivityUtils.getTopActivity();
        new XPopup.Builder(context)
                .dismissOnTouchOutside(false)
                .hasShadowBg(true)
                .moveUpToKeyboard(false)
                .asCustom(new ProdDialog(context, callBack, ProdDialog.ProdType.VipProd))
                .show();
    }

 ...
 * 扫描
 */
public class ScanViewUtil extends View {
    ...
    public ScanViewUtil(Context context) {
        this(context, null);
    }

    public ScanViewUtil(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
        setLayerType(LAYER_TYPE_NONE, null);
    }

    public ScanViewUtil(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

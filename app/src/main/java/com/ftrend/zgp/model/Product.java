...
public class Product extends BaseModel {
    ...
    @Column
    @NotNull
    private String depCode;//商品所属部门编码，商品流水中使用此字段为depCode
    @Column
    @NotNull
    ...
    //  2019/11/27 增加参数prodDepCode，重新生成测试数据
    public Product(String depCode, String prodCode, String barCode, String prodName, String clsCode, String unit, double price) {
     ...
     * @return
     */
    public Product updateSaleInfo(int priceFlag, int isLargess, int forSaleRet, int forDsc,
     ...
     * @return
     */
    public Product updateVipPrice(double vipPrice1, double vipPrice2, double vipPrice3,
